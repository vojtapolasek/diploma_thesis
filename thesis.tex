...
At last I found the solution for limiting number of available CPU cores. On the laptop running Accessible Coconut, I was able to disable individual cores through the following command:

\begin{tt}
echo 0 | tee /sys/devices/system/cpu/cpu7/online
\end{tt}

Where the number 7 can be replaced with number of the core to be turned off. Cores are numbered starting from 0.
