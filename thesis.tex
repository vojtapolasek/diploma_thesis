...
\begin{description}
\item{Elmo1} $4\times14$ CPU Intel Xeon Gold 5120 2.20 GHz, hyperthreading 2 threads per core, supporting AVX512F instruction, 768 GB of RAM
...
\begin{description}
\item{P} number of passwords to be tried
...
\item{S} speed of one machine expressed as number of computed hashes per second
\end{description}
